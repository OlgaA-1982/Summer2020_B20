...
public class WarmUpTasks {
    ...
    public static void main(String[] args) {
        ...
        int arr[] = {5,2,3,4,5,6,4,7,0,-5,-54,-55,45,-45,-45};
        printDesk(arr);

        int[] a1 ={1,2,3,4,5};
        int[] a2 ={6,7,8,9,10,1,12,13,14};
  ...
  // task02:
    public static void printDesk(int[] arr){ //{10,9,20,30,5,6,7};
        Arrays.sort(arr); //{5,6,7,9,10,20,30};

        for(int i=arr.length-1; i >= 0; i--){
            System.out.println( arr[i]+" ");  //30 20 10 9 7 6 5
        }
